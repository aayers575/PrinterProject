...
@JsonDeserialize(builder = CreateVoteRequest.Builder.class)
public class CreateVoteRequest {
    private final String voteId;
    private final String isActive;
    private final Map<String, String> votesByKeyword;

    private CreateVoteRequest(String voteId, String isActive, Map<String, String> votesByKeyword) {
        this.voteId = voteId;
    ...
    public static class Builder {
        ...
        public CreateVoteRequest build() {
            return new CreateVoteRequest(voteId, isActive, votesByKeyword);
        }
    }
}
